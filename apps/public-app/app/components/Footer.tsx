        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/products" className="text-gray-600 hover:text-[#8982cf]">Products</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-[#8982cf]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
