...
function CompleteProfileContent() {
  ...
  const [userRole, setUserRole] = useState<"retailer" | "distributor">(
    "retailer"
  );
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      console.log(
        "❌ No authenticated user after auth check delay, redirecting to signup..."
      );
      router.push("/signup");
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userUpdateError) {
        console.error(
          "❌ Error updating user business info:",
      ...
      if (userRole === "retailer") {
        ...
        if (retailerUpdateError) {
          console.error(
            "❌ Error updating retailer info:",
            retailerUpdateError.message
          );
        ...
        if (distributorUpdateError) {
          console.error(
            "❌ Error updating distributor info:",
            distributorUpdateError.message
          );
      ...
      console.log(
        "🎉 Profile completion successful, cleaning up and redirecting to dashboard..."
      );
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-12 md:p-16">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-base text-gray-600 mb-8 max-w-lg mx-auto leading-relaxed">
            Great! Your email has been verified. Now let&apos;s complete your
            business information to finish setting up your {userRole} account.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              {/* Custom Dropdown */}
              <div
                className={`absolute z-20 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg transition-all duration-200 origin-top ${
                  isDropdownOpen
